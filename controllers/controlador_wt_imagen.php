...
class controlador_wt_imagen extends system {
    ...
    public function modifica_bd(bool $header, bool $ws): array|stdClass
    {
        ...
        $documento_id = $wt_imagen['wt_imagen_id'];
        $r_documento = (new doc_documento($this->link))->modifica_bd(registro: $documento_ins, id:  $documento_id);
        var_dump($r_documento);
        exit;
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al guardar documentos', data: $r_documento);
        }
        ...
        exit;
        $_POST['doc_documento_id'] = $r_documento->registro['doc_documento_id'];
        return parent::modifica_bd($header, $ws); // TODO: Change the autogenerated stub
    }

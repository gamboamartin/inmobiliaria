...
class controlador_wt_imagen extends system {
    ...
    public function alta_bd(bool $header, bool $ws = false): array|stdClass
    {
        ...
        $r_documento = (new doc_documento($this->link))->alta_documento(registro: $documento_ins,file: $_FILES['imagen']);
        if(errores::$error){
            $error = $this->errores->error(mensaje: 'Error al guardar documentos',data:  $r_documento);
            print_r($error);
            die('Error');
        }

        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="top-title">
                    <ul class="breadcrumb">
                        <li class="item"><a href="./index.php?seccion=adm_session&accion=inicio&session_id=8860573944"> Inicio </a></li>
                        <li class="item"><a href="./index.php?seccion=wt_hogar&accion=lista&session_id=8860573944"> Lista </a></li>
